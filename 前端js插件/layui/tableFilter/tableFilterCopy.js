        ...
        var main = function (){
            ...
            layui.each(filters, function(i, filter){
                ...
                filterIcon.on("click", function(e) {
                    ...
                    var filterBox = $(`<div class="layui-table-filter-view" style="top:${t};left:${l};"><div class="layui-table-filter-box">
						<form class="layui-form" lay-filter="table-filter-form">
						   <div></div>
						</form>
					</div>`);
